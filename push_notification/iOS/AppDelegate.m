...
#define UA_KEY @"your_key_here"
#define UA_SECRET @"your_secret_here"
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"livelocal launchOptions = %@", url);
    }    
...
// only valid if livelocal-Info.plist specifies a protocol to handle
